...
import com.match.app.message.entity.AudioMsgBody;
import com.match.app.message.entity.FileMsgBody;
import com.match.app.message.entity.ImageMsgBody;
...
public class ChatsAdapter extends BaseQuickAdapter<MessageEntity, BaseViewHolder> {
    ...
    public ChatsAdapter(Context context, List<MessageEntity> data) {
        super(data);
        setMultiTypeDelegate(new MultiTypeDelegate<MessageEntity>() {
            @Override
            protected int getItemType(MessageEntity entity) {
    ...
    private void setStatus(BaseViewHolder helper, MessageEntity item) {
    ...
    private void setContent(BaseViewHolder helper, MessageEntity item) {
    ...
    private void setOnClick(BaseViewHolder helper, MessageEntity item) {
        MsgBody msgContent = item.getBody();
